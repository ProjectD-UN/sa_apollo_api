...
const port_bot = process.env.BOT_PORT;
const entryPoint_bot = process.env.BOT_ENTRY;
...
const url$1 = process.env.URL;
const port_newsletter = process.env.NEWSLETTER_PORT;
...
const entryPoint = process.env.CENTERS_ENTRY;
const url$2 = process.env.URL;
const port_centers = process.env.CENTERS_PORT;
...
const url$3 = process.env.URL;
const user_port = process.env.USER_PORT;
const entryPoint_user = process.env.USER_ENTRY;
